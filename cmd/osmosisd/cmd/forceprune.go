...
func forceprune() *cobra.Command {
  cmd := &cobra.Command{
    Use:   "forceprune",
    Short: "forceprune",
    Long: `forceprune will delete keys based on retain height shared
Example:
  ...
  cmd.Flags().StringP(fheight, "f", "188000", "Retain Height")
  cmd.Flags().StringP(mheight, "m", "1000", "Retain Height for ABCI Responses")
  return cmd
}
